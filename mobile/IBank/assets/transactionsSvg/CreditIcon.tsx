...
const CreditIcon: FC<TIcon> = ({ width = 24, height = 24, fill = colors.gray100 }) => {
  return (
    <Svg width={width} height={height} fill={fill} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 16 16">
      <Path stroke="none" d="M0 0h24v24H0z" fill="none" /> <Line x1="3" y1="3" x2="21" y2="21" />
      ...
      <Line x1="3" y1="11" x2="11" y2="11" /> <Line x1="15" y1="11" x2="21" y2="11" />
